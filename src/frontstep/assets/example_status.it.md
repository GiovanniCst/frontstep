...
**Stato:** attivo
**Aggiornato:** {today}
**Prossimo passo:** Aggiungi un documento di stato a un progetto che hai davvero, poi cancella questa cartella
**In attesa di:**
**App:** Esempio
**Descrizione:** Il progetto di esempio che Frontstep crea al primo avvio, e il tutorial della sua convenzione
**Tag:** esempio
